...
Allows you to debug line by line your C code
...
Changes if it counts up or counts down
2. What does switch 2 (S2) do?
Turns on or off LED D1
...
int16_t Seven_Seg_Count = 9900; change the number 9900 to 1234
...
Just controls the amount of Voltage going in so it makes it go faster or slower when counting